...
class Setup
{
    ...
    public function setup()
    {
         ...
         */
        // load_theme_textdomain( 'swps', get_template_directory() . '/languages' );
        ...
        */
        ...
        add_theme_support( 'custom-background', apply_filters( 'swps_custom_background_args', array(
