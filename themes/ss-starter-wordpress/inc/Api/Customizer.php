...
use swps\Api\Customizer\Sidebar;
use swps\Api\Customizer\Header;
use swps\Api\Customizer\Footer;
...
class Customizer 
{
	...
	public function output()
	{
		echo '<!--Customizer CSS--> <style type="text/css">';
			echo self::css( '#sidebar', 'background-color', 'swps_sidebar_background_color' );
			echo self::css( '.site-footer', 'background-color', 'swps_footer_background_color' );
			echo self::css( '.site-header', 'background-color', 'swps_header_background_color' );
			echo self::css( '.site-header', 'color', 'swps_header_text_color' );
			echo self::css( '.site-header a', 'color', 'swps_header_link_color' );
