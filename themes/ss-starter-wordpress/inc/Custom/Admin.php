...
namespace swps\Custom;

use swps\Api\Settings;
use swps\Api\Callbacks\SettingsCallback;
...
class Admin
{
	...
	private function enqueue()
	{
		...
		$pages = array( 'toplevel_page_swps' );
	...
	private function enqueue_faq( Settings $settings )
	{
		...
		// Pages array to where enqueue scripts
		$pages = array( 'swps_page_swps_faq' );
	...
	private function settings()
	{
		...
		$args = array(
			array(
				'option_group' => 'swps_options_group',
				'option_name' => 'first_name',
				'callback' => array( $this->callback, 'swps_options_group' )
			),
			array(
				'option_group' => 'swps_options_group',
				'option_name' => 'swps_test2'
			)
		);
	...
	private function sections()
	{
		...
		$args = array(
			array(
				'id' => 'swps_admin_index',
				'title' => 'Settings',
				'callback' => array( $this->callback, 'swps_admin_index' ),
				'page' => 'swps'
			)
		);
